...
if [[ ! -e /intel/bin/container/launch ]]; then
	ln -s /intel/bin/container/app-launcher.sh /intel/bin/container/launch
fi

if [[ ! -e /intel/bin/container/launch-x ]]; then
	ln -s /intel/bin/container/app-launcher-x.sh /intel/bin/container/launch-x
fi

if [[ ! -e /intel/bin/container/launch-h ]]; then
	ln -s /intel/bin/container/headless.sh /intel/bin/container/launch-h
fi

if [[ ! -e /intel/bin/container/igt_run ]]; then
	ln -s /intel/bin/container/igt_run.sh /intel/bin/container/igt_run
fi
